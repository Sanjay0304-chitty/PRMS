...
windows
rmdir /s /q node_modules del package-lock.json npm install npm rebuild npx prisma generate npx prisma db push npm run dev

Linux
rm -rf node_modules rm package-lock.json npm install npm rebuild npx prisma generate npx prisma db push npm run dev
